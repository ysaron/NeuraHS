...
def test_cardlist_view(client):
    url = reverse_lazy('gallery:realcards')
...
@pytest.mark.django_db
def test_write_card_classes(hs_db_worker):
...
@pytest.mark.django_db
def test_write_tribes(hs_db_worker):
...
@pytest.mark.django_db
def test_write_card_sets(hs_db_worker):
...
@pytest.mark.django_db
def test_write_cards(hs_db_worker):
    hs_db_worker.write_card_classes()
    hs_db_worker.write_tribes()
    hs_db_worker.write_card_sets()
