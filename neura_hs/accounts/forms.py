...
about_placeholder = _('A couple of words (optional); will be displayed next to your nickname')
...
class RegisterUserForm(auth_forms.UserCreationForm):
    ...
    password2 = forms.CharField(label=_('Password (again)'), widget=forms.PasswordInput(attrs={'class': 'form-input'}))
    about = forms.CharField(label=_('About you'), required=False,
